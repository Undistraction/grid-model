...
var isPositiveNumber = function isPositiveNumber(value) {
  return isNumber_1$1(value) && value >= 0;
};

var isPositiveInteger = function isPositiveInteger(value) {
  return isInteger_1(value) && value >= 0;
};
...
var validateArgs = function validateArgs(width, height, aspectRatio) {
  if (width && !isNumber_1$1(width)) throwInvalidParamError('width', width);

  if (height && !isNumber_1$1(height)) throwInvalidParamError('height', height);

  if (isNumber_1$1(aspectRatio) && !isPositiveNumber(aspectRatio)) throwInvalidParamError('aspectRatio', aspectRatio);

  // Validate we have the params we need
  if ([width, height, aspectRatio].filter(function (x) {
    return isNumber_1$1(x);
  }).length !== 2) {
    throwIncorrectNumberOfParamsError();
  }

  return {
    validatedWidth: isNumber_1$1(width) ? width : height * aspectRatio,
    validatedHeight: isNumber_1$1(height) ? height : width / aspectRatio,
    validatedAspectRatio: isNumber_1$1(aspectRatio) ? aspectRatio : width / height
  };
};
...
var validateArgs$2 = function validateArgs(x, y) {
  if (!isNumber_1$1(x) || !isNumber_1$1(y)) {
...
var validateParams = function validateParams(width, height, aspectRatio, rows, columns, cellWidth, cellHeight) {
  ...
  if (isNumber_1$1(columns) && isNumber_1$1(cellWidth) && isNumber_1$1(width) || isNumber_1$1(rows) && isNumber_1$1(cellHeight) && isNumber_1$1(height)) {
...
var canDeriveWidth = function canDeriveWidth(cellHeight, rows) {
  return !!(isNumber_1$1(cellHeight) && isNumber_1$1(rows));
};
...
var canDeriveHeight = function canDeriveHeight(cellWidth, columns) {
  return !!(isNumber_1$1(cellWidth) && isNumber_1$1(columns));
};
...
var canDeriveColumns = function canDeriveColumns(width, cellWidth) {
  return !!(isNumber_1$1(width) && isNumber_1$1(cellWidth));
};
...
var canDeriveRows = function canDeriveRows(height, cellHeight) {
  return !!(isNumber_1$1(height) && isNumber_1$1(cellHeight));
};
...
var saveDimensions = function saveDimensions(width, height, aspectRatio, columns, rows, cellWidth, cellHeight, gutterWidth, gutterHeight) {
  if (!isNumber_1$1(width) && !isNumber_1$1(aspectRatio)) {
    if (canDeriveWidth(cellHeight, rows)) {
      width = deriveWidth(columns, cellWidth, gutterWidth);
    }
  }

  if (!isNumber_1$1(height) && !isNumber_1$1(aspectRatio)) {
...
var saveMatrixDimensions = function saveMatrixDimensions(columns, rows, dimensions, cellWidth, cellHeight) {
  var c = isNumber_1$1(columns) ? columns : canDeriveColumns(dimensions.width, cellWidth) && deriveColumns(dimensions.width, cellWidth);
  var r = isNumber_1$1(rows) ? rows : canDeriveRows(dimensions.height, cellHeight) && deriveRows(dimensions.height, cellHeight);
...
var saveCellDimensions = function saveCellDimensions(cellWidth, cellHeight, gutterWidth, gutterHeight, dimensions, matrixDimensions) {
  var width = isNumber_1$1(cellWidth) ? cellWidth : deriveCellWidth(dimensions.width, gutterWidth, matrixDimensions.width);
  var height = isNumber_1$1(cellHeight) ? cellHeight : deriveCellHeight(dimensions.height, gutterHeight, matrixDimensions.height);
...
var saveGutterDimensions = function saveGutterDimensions(gutterWidth, gutterHeight, dimensions, matrixDimensions, cellDimensions) {
  ...
  if (matrixDimensions.width > 1 && isNumber_1$1(gutterWidth) && gutterWidth !== calculatedGutterWidth || matrixDimensions.height > 1 && isNumber_1$1(gutterHeight) && gutterHeight !== calcualtedGutterHeight) {
    throwError(CONFLICTING_PARAMS_MESSAGE);
  }
...
var validateColumnIndex = function validateColumnIndex(index, total) {
  if (isNil_1$1(index) || !isPositiveInteger(index) || !columnExists(index, total)) {
...
var validateRowIndex = function validateRowIndex(index, total) {
  if (isNil_1$1(index) || !isPositiveInteger(index) || !rowExists(index, total)) {
...
var createGrid = function createGrid() {
  ...
  if (!isNumber_1$1(gutterWidth) && isNumber_1$1(gutter)) gutterWidth = gutter;
  if (!isNumber_1$1(gutterHeight) && isNumber_1$1(gutter)) gutterHeight = gutter;
  ...
  var regionForColumns = function regionForColumns(start, end) {
    ...
    var endCell = regionForCellAt(!isNil_1$1(end) ? end : start, matrixDimensions.height - 1);
  ...
  var regionForRows = function regionForRows(start, end) {
    ...
    var endCell = regionForCellAt(matrixDimensions.width - 1, !isNil_1$1(end) ? end : start);
